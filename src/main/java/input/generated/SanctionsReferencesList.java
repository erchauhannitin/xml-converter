 ...
 *       &lt;sequence>
 *         &lt;element ref="{}ReferenceName" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SanctionsReferencesList")
public class SanctionsReferencesList {

    @XmlElement(name = "ReferenceName", required = true)
    protected List<ReferenceName> referenceName;
     ...
     * 
     */
    public List<ReferenceName> getReferenceName() {
        if (referenceName == null) {
            referenceName = new ArrayList<ReferenceName>();
        }
